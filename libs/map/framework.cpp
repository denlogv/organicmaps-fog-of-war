...
namespace
{
std::string_view constexpr kFogThrottleSpeedKeys[] = {kFogThrottleSpeed1Key, kFogThrottleSpeed2Key,
                                                      kFogThrottleSpeed3Key};
// Defaults in km/h: ~5 km/h (walking), ~20 km/h (cycling), ~50 km/h (driving)
int constexpr kFogThrottleSpeedDefaults[] = {5, 20, 50};
std::string_view constexpr kFogThrottleIntervalKeys[] = {kFogThrottleInterval1Key, kFogThrottleInterval2Key,
                                                         kFogThrottleInterval3Key, kFogThrottleInterval4Key};
